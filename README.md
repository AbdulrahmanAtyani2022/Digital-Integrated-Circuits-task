...
Welcome to the repository for ENCS3330: Digital Integrated Circuits.
This project showcases the complete design cycle of CMOS logic gates — from ideal transistor schematics to physical silicon layouts.

🎯 task Goals
The mission was to bridge the gap between theory and reality.
We designed three fundamental gates and analyzed how real-world parasitics (like resistance and capacitance) slow down digital signals.
